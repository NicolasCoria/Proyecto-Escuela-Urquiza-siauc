...
const AdminFAQs = () => {
  ...
  useEffect(() => {
    const fetchFaqs = async () => {
      try {
        const response = await axios.get('/faqs/admin');
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h1>Preguntas Frecuentes - Administrador</h1>
      ...
      <div className={styles.contact}>
        ...
        <p>
          Si tienes alguna pregunta específica que no está cubierta aquí, contacta al equipo
          técnico.
        </p>
      </div>
    </div>
